...
export default function Details(props) {
    ...
    // "https://yeh-bucket.s3.ap-northeast-2.amazonaws.com/20f8a0fe-5bb4-4e1d-86c4-a5670c1c22ae.jpg"
    return (
        <div className="detailPost">
          ...
          <div className="detailPostBox_footer">
            <div className="detailPostBox_footer_info">
              {/* <p><LikeOutlined /> {datailData.comments !== null ? datailData.comments.length : null}</p> */}
