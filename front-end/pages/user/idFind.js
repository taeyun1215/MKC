...
export default function idFind() {
    ...
    return (
    <div className="sign" style={{ width: '25%' , padding : '50px', border : '1px solid lightgray', borderRadius:'10px'}}>
        <div className="idFind">
            <span>가입한 이메일 주소를 입력주세요.</span>
            <input placeholder="example@goldenplanet.co.kr" onChange={handleOnChange} onKeyUp={handleonKeyUp}/>
